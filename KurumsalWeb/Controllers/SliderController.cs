...
namespace KurumsalWeb.Controllers
{
    public class SliderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SliderId,Baskik,Aciklama,ResimURL")] Slider slider,HttpPostedFileBase ResimURL)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SliderId,Baskik,Aciklama,ResimURL")] Slider slider,HttpPostedFileBase ResimURL,int id)
        {
            if (ModelState.IsValid)
            {
